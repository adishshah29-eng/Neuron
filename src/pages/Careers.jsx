...
const Careers = () => {
  return (
    <div style={{ paddingTop: '80px', minHeight: 'calc(100vh - 400px)', backgroundColor: 'var(--color-bg)' }}>
      <div className="container" style={{ paddingBlock: '4rem', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '1.25rem', color: '#4A5568', maxWidth: '600px', margin: '0 auto 4rem' }}>
